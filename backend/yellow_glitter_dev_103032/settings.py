"""
Django settings for yellow_glitter_dev_103032 project.
...
ROOT_URLCONF = 'yellow_glitter_dev_103032.urls'
...
WSGI_APPLICATION = 'yellow_glitter_dev_103032.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_glitter_dev_103032 API",
    "DESCRIPTION": "API documentation for yellow_glitter_dev_103032 App",
    "VERSION": "v1",
}
